...
async function logAdmin(type, title, description, color, fields) {
    ...
    try {
        ...
        await fetch(`${ADMIN_LOG_URL}/api/logs/ingest`, {
            ...
            body: JSON.stringify({ source: 'zitatboard', type, title, description, color, fields }),
...
logAdmin('SYSTEM', '\u{1F680} zitatboard gestartet', `Prozess laeuft, PID ${process.pid}.`, 0x57F287);
